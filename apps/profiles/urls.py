...
from .views import (AgentListAPIView, CarOwnersListAPIView, GetProfileAPIView,
                    LinkEmailPasswordAPIView, RentersListAPIView,
                    TopAgentsListAPIView, UpdateProfileAPIView)

urlpatterns = [
    path("me/", GetProfileAPIView.as_view(), name="get_profile"),
    path("me/email-login/", LinkEmailPasswordAPIView.as_view(), name="link_email_login"),
